...
function fetchWeatherData(city) {
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city},MI,US&appid=${apiKey}&units=imperial`)
    ...
    fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${city},MI,US&appid=${apiKey}&units=imperial`)
    .then(response => response.json())
    .then(data => {
        console.log(data);
